...
<meta charset="UTF-8">
    ...
    <title>New Patient | Ophtha</title>
</head>
<body class="text-center">
  ...
  <form class="form-signin" action="new_patient_insert.php" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <br>
    <h1 class="h3 mb-3 font-weight-normal">New patient</h1>
    <br>
  
    <input type="text" placeholder="ID Type" class="form-control" name="idType" required/>
    <input type="text" placeholder="Patient ID" class="form-control" name="id" required/>
    ...
    <input type="text" placeholder="Interest" class="form-control" name="interest" required/>
