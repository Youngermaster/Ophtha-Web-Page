...
CREATE TABLE `llamada` (
  ...
  `comentario` varchar(170) DEFAULT NULL,
  PRIMARY KEY (`idLlamada`),
  KEY `codigo` (`codigo`),
  KEY `tipo_id` (`tipo_id`,`id`),
  CONSTRAINT `llamada_ibfk_1` FOREIGN KEY (`codigo`) REFERENCES `empresa` (`codigo`),
  CONSTRAINT `llamada_ibfk_2` FOREIGN KEY (`tipo_id`, `id`) REFERENCES `paciente` (`tipo_id`, `id`)
